...
[res, hMaster] = Nim_create_master(2)   #0-CANopen 1-EtherCAT 2-Modbus
if res == 0:
    #CANopen
    ...
    if nCurAddr > 0:
        ...
        Nim_set_workMode(hMaster, nCurAddr, ServoWorkMode.SERVO_PP_MODE, 1)
        time.sleep(0.05)     # 必要延时(Nim_set_workMode)
        Nim_set_profileVelocity(hMaster, nCurAddr, 10.0)
        Nim_set_profileAccel(hMaster, nCurAddr, 12.5)
        Nim_set_profileDecel(hMaster, nCurAddr, 12.5)
        Nim_power_on(hMaster, nCurAddr, 1)
        time.sleep(0.2)      # 必要延时(Nim_power_on后)
        print("********************move relative*********************")
        Nim_moveRelative(hMaster, nCurAddr, 10.0, 0, 0)
        time.sleep(0.2)
        ...
        time.sleep(0.2)
        print("********************move Absolute*********************")
        Nim_moveAbsolute(hMaster, nCurAddr, 0, 0, 0)
        time.sleep(0.2)
