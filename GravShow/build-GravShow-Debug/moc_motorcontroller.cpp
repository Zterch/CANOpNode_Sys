...
QT_MOC_LITERAL(1, 16, 11), // "commandSent"
...
QT_MOC_LITERAL(5, 45, 5) // "error"
    ...
    "MotorController\0commandSent\0\0success\0"
    "message\0error"
};
...
void MotorController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->commandSent((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        ...
        {
            using _t = void (MotorController::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorController::commandSent)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MotorController::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MotorController::error)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MotorController::commandSent(bool _t1, const QString & _t2)
{
...
// SIGNAL 1
void MotorController::error(const QString & _t1)
{
